public class DenganMethod {
    ...
    public static int hitungTotalPenghasilan(int gajiPokok, int tunjangannTransport, int tunjanganMakan, int bonus){
        return gajiPokok + tunjangannTransport + tunjanganMakan + bonus;
    }
